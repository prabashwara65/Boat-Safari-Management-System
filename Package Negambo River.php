...
<!DOCTYPE html>
    <html lang="eng" dir="ltr">
        ...
        <Body>
            ...
            <div class="image">
                <img src="img/photo56.jpg"" alt="Background image">  
                
            </div>

            <p class="Package-name">
               Negambo River Boat Safari Ampara
            </p>
            ...
            <p class="Description">  
            Negombo River Boat Safari offers an exciting adventure along the scenic waterways of the Negombo Lagoon, located in the coastal city of Negombo, Sri Lanka.
             This safari allows visitors to explore the rich biodiversity of the lagoon and its surrounding mangrove forests while enjoying a memorable boat ride.
                <span class="highlight"> Negombo River Boat Safari. </span> Located in the beautiful coastal region of Sri Lanka, the Madu River is a tranquil waterway 
                ...
                The Negombo Lagoon is home to a diverse range of bird species, making it a paradise for birdwatchers. You can spot a variety of birds, including 
                kingfishers, herons, egrets, and even migratory birds during the appropriate seasons. The experienced guides accompanying you on
            </p>
            ...
            <div class="container">
                <div class="left-side">
                            ...
                            <ul>
                            <li>Time duration     - 1 to 3 hours</li> <br>
                            <li>Starting onwards  
                                                <ul class="WEEKtime">
                                                    <li style="font-weight: normal">- 10.00 am week days </li>
                                                    <li >- 07.30 am on weekends</li>
                                                </ul>
                            </li><br>
                            ...
                            <li style="font-weight: bolder;">Package price   : <span style="color: rgb(73, 29, 29);">Rs. 45 000.00 </span> </li>
                            <br>
                    ...
                    <div class="right-side">
                        <img src="img/photo18.jpg" alt="Image 1"> 
                        <img src="img/photo48.jpg" alt="Image 2"> 
                        <img src="img/photo42.jpg" alt="Image 3"> 
                        <img src="img/photo35.jpg" alt="Image 4"> 
                        <img src="img/photo15.jpg" alt="Image 5"> 
                        <img src="img/photo29.jpg" alt="Image 6"> 
                        <img src="img/photo25.jpg" alt="Image 7"> 
                        <img src="img/photo44.jpg" alt="Image 8">
                        <img src="img/photo10.jpg.jpg"" alt="Image 9"> 
