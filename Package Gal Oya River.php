...
<!DOCTYPE html>
    <html lang="eng" dir="ltr">
        ...
        <Body>
            ...
            <div class="image">
                <img src="img/photo55.jpg" alt="Background image">  

            </div>

            <p class="Package-name">
                Gal Oya Boat Safari Ampara
            </p>
            ...
            <p class="Description">  
            Gal Oya Boat Safari offers a captivating wildlife experience in the Gal Oya National Park, located in Ampara, 
            Sri Lanka. This unique safari allows visitors to explore the park's stunning landscapes and encounter a diverse 
            range of wildlife while cruising on the serene Gal Oya reservoir.<span class="highlight"> Gal oys Boat Safari. 
            </span> LDuring the boat safari, you will have the opportunity to witness the natural beauty of the park, surrounded
             by lush forests, grasslands, and majestic mountains. The highlight of the safari is observing wildlife in their natural
              habitat, including elephants, crocodiles, deer, water buffalos, and various bird species.
                <br><br>
            ...
            <div class="container">
                <div class="left-side">
                            ...
                            <ul>
                            <li>Time duration     - 4 hours</li> <br>
                            <li>Starting onwards  
                                                <ul class="WEEKtime">
                            ...
                            <li>Whats included list
                                <ul>
                                    ...
                                    <li>Photographer</li>
                                    <li>Hotel Pick Up</li>
                                    <li>Travell Guider</li>
                                </ul>
                            </li> <br>

                            <li style="font-weight: bolder;">Package price   : <span style="color: rgb(73, 29, 29);">Rs. 35 000.00 </span> </li>
                            <br>
                    ...
                    <div class="right-side">
                        <img src="img/photo40.jpg" alt="Image 1"> 
                        <img src="img/photo18.jpg" alt="Image 2"> 
                        <img src="img/photo13.jpg" alt="Image 3"> 
                        <img src="img/photo38.jpg" alt="Image 4"> 
                        <img src="img/photo22.jpg" alt="Image 5">   
                        <img src="img/photo45.jpg" alt="Image 6"> 
                        <img src="img/photo32.jpg" alt="Image 7"> 
                        <img src="img/photo41.jpg" alt="Image 8">
